...
const Experience = () => {
	return (
		<section
			id='about'
			className='py-5 w-full px-2 md:px-10 lg:px-16 xl:px-20 2xl:px-72 text-[#0f172a] mt-10 lg:mt-28 mb-3 lg:mb-28'
		>
			<div className='flex justify-between flex-col lg:flex-row items-center'>
				<div className='bg-transparent'>
					<div className='relative bg-gradient-to-b from-slate-100 to-white rounded-xl h-[430px] w-[360px] border-b'>
						...
						<div className='absolute bottom-10 right-0 lg:-right-28 p-[2px] bg-gradient-to-l from-slate-400 to-slate-200 rounded-md'>
				...
				<div className='flex flex-col justify-end'>
					<h1 className='text-5xl font-extrabold mb-5 mt-10 lg:mt-0'>
						My Advantage
					</h1>
					<p className=''>
