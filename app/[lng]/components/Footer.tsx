...
const Footer = ({ lng }: any) => {
	...
	return (
		<footer className='py-5 xl:py-10 w-full mt-16 bg-[#0f172a] text-white px-2 md:px-10 lg:px-16 xl:px-20 2xl:px-72 lg:h-screen 2xl:h-[75vh]'>
			<section className='py-10 -translate-y-[80%] px-2 md:px-6 lg:px-14 mt-12 rounded-2xl flex flex-wrap justify-between items-center bg-[url("/images/newsletter-bg.webp")] bg-cover'>
				...
				<div className='p-16 min-w-[50%] h-full'>
					<div className='glass-effetct shadow p-1 rounded-full flex gap-x-2 justify-between border-white/30 border-[0.2px]'>
						<input
							type='text'
